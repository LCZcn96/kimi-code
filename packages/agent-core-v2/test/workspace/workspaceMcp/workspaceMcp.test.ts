 ...
 * The credential-event subscription reconciles entries whose OAuth grant was
 * saved, invalidated, or whose proactive refresh failed — deferring to the
 * initial connect of a still-pending entry, ignoring flow-local
 * (client/discovery) invalidations, and never touching disabled/removed
 * entries.
 *
